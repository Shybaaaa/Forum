...
<div class="h-screen">
    <section class="w-[80%] h-[80%] mt-[5%] rounded-lg shadow-md space-y-4 max-h-fit bg-white mx-auto gap-x-7 gap-y-9 px-6 py-4 overflow-x-hidden">
        <div class="mb-2 flex flex-row border-b-2 h-16 items-center justify-between">
            <h2 class="text-lg text-black font-bold"><a href="/index.php?page=home" class="inline-flex items-center"><i class="fa-solid fa-<?= $category["icons"]?> bg-indigo-500 text-white p-2 rounded-full shadow-md  mr-3"></i><?= ucfirst($category["name"]) ?></a></h2>
