...
<div class="container max-w-screen gap-y-3 overflow-y-hidden min-h-screen flex flex-wrap py-6">
    <?php foreach ($categorys as $category) : ?>
        <section class="w-[80%] h-fit rounded-lg shadow-md space-y-4 max-h-fit bg-white mx-auto gap-x-7 gap-y-9 px-6 py-4 overflow-x-hidden dark:bg-slate-700">
                            ...
                            <div class="flex flex-row w-1/4 items-center gap-x-8">
                                ...
                                <div class="flex flex-col w-full gap-y-2">
                                    ...
                                    <div class="flex flex-row items-center gap-x-2">
                                        <i class="fa-solid fa-calendar text-gray-500 slate-300"></i>
