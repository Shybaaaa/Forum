    ...
    <div class="overflow-x-auto h-full flex flex-col justify-between">
        <div>
            <div class="w-full m-3">
                <h3 class="text-lg font-semibold border-b-2 border-spacing-y-3 w-full border-separate border-gray-200">Modification du post - <?= $post["reference"] ?></h3>
            </div>
            <form action="" method="post" class="space-y-3" enctype="multipart/form-data">
                ...
                <div class="flex-row flex items-center justify-around">
                    <label for="title" class="block text-gray-800 w-1/4 text-center font-medium">Titre :</label>
                    <input type="text" name="title" id="title" autocomplete="title" class="rounded-lg mx-auto border-gray-300 w-1/2 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-400 focus:ring-opacity-50" value="<?= $post["title"] ?>">
                </div>
                <div class="border-b border-separate w-1/2 mx-auto"></div>
                <div class="flex flex-row items-center justify-evenly">
                    <label for="category" class="block text-gray-800 w-1/4 text-center font-medium">Catégories :</label>
                    <select name="category" id="category" class="w-1/2 rounded-lg mx-auto border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-400 focus:ring-opacity-50">
