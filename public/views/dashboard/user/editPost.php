        ...
        <div>
            ...
            <form action="" method="post" class="space-y-3" enctype="multipart/form-data">
                ...
                <div class="flex-row flex items-center justify-around">
                    ...
                    <input type="text" name="title" id="title" autocomplete="title" class="rounded-lg mx-auto border-gray-300 w-1/2 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-400 focus:ring-opacity-50 dark:bg-slate-600 text-slate-300" value="<?= $post["title"] ?>">
                </div>
                <div class="border-b border-separate w-1/2 mx-auto"></div>
                ...
                <div class="w-full">
                    ...
                    <textarea name="description" id="description" rows="15" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-400 focus:ring-opacity-50 dark:bg-gray-600 text-slate-200"><?= $post["description"] ?></textarea>
                </div>
                <div>
