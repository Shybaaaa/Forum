                ...
                <?php foreach ($posts as $post): ?>
                    <tr class="border-b dark:border-neutral-600">
                        ...
                        <td class="px-6 py-5 flex flex-row gap-x-3 *:text-sm">
                            ...
                            <?php if(!$post["isDeleted"]): ?>
                                <button value="<?= $post["id"]?>" class="btnDelete" data-modal-target="deleteModal" data-modal-toggle="deleteModal"><i title="Supprimé" class="fa-solid fa-trash text-red-600"></i></button>
                            <?php else: ?>
