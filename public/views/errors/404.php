        ...
        <div class="row">
            <div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                <div class="relative ">
                    ...
                    <span class="absolute  top-0   -ml-12  text-gray-300 font-semibold">Ouups!</span>
                </div>
                <h5 class="text-gray-300 font-semibold -mr-10 -mt-3">Page introuvable</h5>
                <p class="text-gray-100 mt-2 mb-6">Nous sommes désolés, mais la page que vous avez demandée n'a pas été trouvée.</p>
                <a
                    href="/"
                    class="bg-green-400  px-5 py-3 text-sm shadow-sm font-medium tracking-wider hover:bg-green-400/90 duration-75 transition-all text-gray-50 rounded-full hover:shadow-lg">
                    Retour à l'accueil
                </a>
            </div>
        </div>
