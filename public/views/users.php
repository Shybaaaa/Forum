...
<form method="post" action="">
    <label class="group mx-auto my-3 w-[95%] xl:w-100% relative bg-white min-w-sm max-w-2xl flex flex-col md:flex-row items-center justify-center border p-1 rounded-2xl shadow-md" for="searchbar">
...
<div class="h-screen">
    <div class="w-[95%] h-[90%] xl:w-[90%] overflow-y-scroll rounded-lg shadow-sm bg-white mx-auto px-6 py-4 dark:bg-slate-700">
